...
function SalesChart({ bookings, numDays, loadingStates }) {
    const { modeState } = useDarkModeStateContext();
    if (loadingStates) {
        return (
            <StyledSalesChart>
                <Heading as="h2">
                    Sales from <span>MM DD YYYY &mdash; MM DD YYYY</span>
                </Heading>
                <SpinnerWrapper>
                    <SpinnerMini />
                </SpinnerWrapper>
